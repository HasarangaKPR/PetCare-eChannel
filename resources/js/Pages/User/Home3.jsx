...
import banner3 from './Assets/banner01.png';
...
export default function Home3({ auth, laravelVersion, phpVersion }) {
                    ...
                    <div className="">
                        ...
                        <main className=" "> {/* Added padding to the main content */}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12 px-8">
                                {/* Card 1 */}
                                <Link  href={route('user.home1')} className="flex items-center bg-white shadow-lg p-4 rounded-3xl hover:shadow-2xl transition-shadow">
                                    <img
                                        src={icon3}
                                        alt="Service Icon"
                                        className="mr-4"
                                ...
                                {/* Card 3 */}
                                <Link href={route('user.home3')} className="flex items-center bg-[#156862] shadow-lg p-4 rounded-3xl hover:shadow-2xl transition-shadow">
                                    <img
                                        src={icon1}
                                        alt="Bookings Icon"
                                        className="mr-4"
                                    />
                                    <div>
                                        <h3 className="font-bold text-lg text-white">Pet Services</h3>
                                        <p className="text-sm text-gray-200">Pet Care Services</p>
                                    </div>
                                </Link>
